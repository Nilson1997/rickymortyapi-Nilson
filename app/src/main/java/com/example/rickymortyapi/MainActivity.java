...
public class MainActivity extends AppCompatActivity {
        ...
        rickyMortyRespuestaCall.enqueue(new Callback<RickyMortyRespuesta>() {
            ...
            public void onResponse(Call<RickyMortyRespuesta> call, Response<RickyMortyRespuesta> response) {
                ...
                if (response.isSuccessful()) { //
                    RickyMortyRespuesta rickyMortyRespuesta = response.body(); //
                    List<RickyMorty> listaRickyMorty = rickyMortyRespuesta.getResults(); //
    ...
    private void setImageView() {
        String url = "https://imgmedia.larepublica.pe/640x377/larepublica/original/2022/07/27/62e16b12ad0b3025fa7885b8.webp";
        Glide.with(this)
                .load(url)
